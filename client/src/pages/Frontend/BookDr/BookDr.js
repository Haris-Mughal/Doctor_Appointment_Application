...
export default function BookDr() {
  ...
  const handleBooking = () => {
    ...
    axios
      .post("http://localhost:7000/appointment/addApoint", formData)
      .then((response) => {
            ...
            <div className="col-12 col-md-6 col-lg-6 d-flex align-items-center">
              <div className="div">
                ...
                <div className="imgDetail m-4">
                  <h5>
                    Dr.Devil <span className="fs-6 ms-3"> ⭐ 4.9(250)</span>
                  </h5>
                  <p className="fs-6">
                    Oncologist <br />
                    <span className="text-body-tertiary ">
                      <i className="fa-solid fa-location-dot"></i> Henderson,
                      Colorado
                    </span>{" "}
                    <br />
                    ...
                    <div className="timeSlot mt-3">
                      ...
                      {isConfirm ? (
                        <div className="body py-3">
                          <div className="row">
                            <div
                              className="col-12 text-center d-flex flex-wrap"
                          ...
                          <div className="row Box">
                            <div className="col">
                              ...
                              <div className="d-flex justify-content-center ">
                                <p className=" w-75">
                                  You're booked with Erik Sanders. An invitation
          ...
          <div className="info pb-5">
              ...
              <div className="col">
                ...
                <div className="list mt-3">
                  <ul>
                    ...
                    <li>Spoken Language: English, Hindi, Urdu, Punjabi</li>
                    <li>Registration Number : 2403</li>
                  </ul>
                </div>
            ...
            <div className="row">
              <div className="col-12 col-md-6 col-lg-3 mt-3">
                <ul>
                  <li className="text-secondary fw-bold ">PhD</li>
                  <li>2019</li>
                  <li>Oncology</li>
                  <li>Punjab Medical Institute</li>
                </ul>
              </div>
              <div className="col-12 col-md-6 col-lg-3 mt-3">
                <ul>
